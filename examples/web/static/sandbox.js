document.addEventListener("DOMContentLoaded", () =>
{
    ...
    const popKeyInput = document.getElementById("pop-key");
    ...
    // Add a console log event listener
    populateButton.addEventListener("click", () =>
    {
        if (!popIdInput.value || !popKeyInput.value)
        {
            alert("Pop ID or Secret Key is empty.");
            return;
        }

        consoleOutputInput.value = "Console Output: \n";
        popId = popIdInput.value;
        popKey = popKeyInput.value;
        console.log("Pop ID: ", popId);
        console.log("Pop Key: ", popKey);
