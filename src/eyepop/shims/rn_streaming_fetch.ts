...
import { EyepopLineDecoder } from '../streaming'
import { parseHttpHeader } from './rn_http_header_parser'
import { ResponseParser } from 'EyePop/shims/rn_http_response_parser'
...
export async function reactNativeStreamingFetch(
    ...
    return new Promise((resolve, reject) => {
        ...
        client.connect(connectOptions, async () => {
            ...
            const readableHeaderChunkedBodyReader = readableHeaderChunkedBody.getReader()
