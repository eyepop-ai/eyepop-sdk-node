...
The complete component reference — every component type, its attributes, and how components chain — is published at **[Component Reference](https://docs.eyepop.ai/platform/pop-reference)**, with worked pipelines at **[Examples](https://docs.eyepop.ai/platform/pop-examples)**.
