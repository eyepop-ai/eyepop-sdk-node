...
const HAND_CONNECTIONS = [
    ...
    ['wrist', 'index finger mcp'],
    ['index finger mcp', 'index finger pip'],
    ['index finger pip', 'index finger dip'],
    ['index finger dip', 'index finger tip'],

    ['wrist', 'middle finger mcp'],
    ['middle finger mcp', 'middle finger pip'],
    ['middle finger pip', 'middle finger dip'],
    ['middle finger dip', 'middle finger tip'],

    ['wrist', 'ring finger mcp'],
    ['ring finger mcp', 'ring finger pip'],
    ['ring finger pip', 'ring finger dip'],
    ['ring finger dip', 'ring finger tip'],
    ...
    ['index finger mcp', 'middle finger mcp'],
    ['middle finger mcp', 'ring finger mcp'],
    ['ring finger mcp', 'pinky mcp'],
]
